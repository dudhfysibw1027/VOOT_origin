...
class CSpace(object):
  ...
  @staticmethod
  def robot_body(body):
    return CSpace(body, indices=list(range(body.GetDOF())))
  # noinspection PyUnresolvedReferences
  @staticmethod
  def robot_body_and_base(body):
    # noinspection PyUnresolvedReferences
    return CSpace(body, indices=list(range(body.GetDOF())), affine_mask=DOFAffine.X|DOFAffine.Y|DOFAffine.RotationAxis, rotation_axis=[0, 0, 1])
  def __str__(self):
