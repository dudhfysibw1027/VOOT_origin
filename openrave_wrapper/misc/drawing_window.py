...
class DrawingWindow:
    ...
    def draw_rect(self, xxx_todo_changeme, xxx_todo_changeme1, color="black"):
    ...
    def draw_oval(self, xxx_todo_changeme2, xxx_todo_changeme3, color="black"):
    ...
    def draw_line(self, xxx_todo_changeme4, color="black"):
